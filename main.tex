...
\input{sections/03SpokedRunner.tex}
\input{sections/04Simulation_Result.tex}

\input{sections/05Code_Implementation.tex}
...
The more general way to find fixed-point is to simulate the system, and evaluate the difference of the periodic condition at the Poincare section as the cost/constraint. \underline{Trajectory Optimization}% is a collection of optimization/root finding methods can find the fixed-point or even the limit cycle solution is called :
\begin{itemize}
